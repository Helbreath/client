...
static const char * sideName[MAXSIDES] = { "Traveler", "Aresden", "Elvine"/*, "Istria" */};
...
using GuildMap = map<int16_t, class CGuild*>;
using GuildMapIter = GuildMap::iterator;
using GuildMapCIter = GuildMap::const_iterator;
using Astoria = std::auto_ptr<class CAstoria>;

using ClientList = std::list<class CClient*>;
using ClientListIter = ClientList::iterator;
using ClientListCIter = ClientList::const_iterator;
