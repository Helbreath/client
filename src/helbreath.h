...
/*
    ...
    void _RequestMapStatus(std::string_view pMapName, int iMode);
    ...
    dialog_box m_dialogBoxes[MAXDIALOGBOX];
    ...
    class effect * m_pEffectList[MAXEFFECTS];
    ...
    magic * m_pMagicCfgList[MAXMAGICTYPE];
    skill * m_pSkillCfgList[MAXSKILLTYPE];
