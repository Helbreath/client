...
CMapData::CMapData(class helbreath * pGame)
{
    int i;
    m_pGame = pGame;
...
bool CMapData::bGetIsLocateable(short sX, short sY)
{
    ...
    if (m_pData[dX][dY].m_sOwnerType != 0)
        return false;
    if (m_tile[sX][sY].m_bIsMoveAllowed == false)
        return false;
    if (m_pData[dX][dY].m_sDynamicObjectType == DYNAMICOBJECT_MINERAL1)
        return false;
    if (m_pData[dX][dY].m_sDynamicObjectType == DYNAMICOBJECT_MINERAL2)
        return false;
    if (m_pData[dX][dY].m_sDynamicObjectType == DYNAMICOBJECT_ARESDENFLAG)
        return false;
    if (m_pData[dX][dY].m_sDynamicObjectType == DYNAMICOBJECT_ELVINEFLAG)
        return false;

    if (m_pData[dX + 1][dY + 1].m_sOwnerType == 66)
        return false;
    if (m_pData[dX + 1][dY].m_sOwnerType == 66)
        return false;
    if ((dY > 0) && (m_pData[dX + 1][dY - 1].m_sOwnerType == 66))
        return false;
    if (m_pData[dX][dY + 1].m_sOwnerType == 66)
        return false;
    if (m_pData[dX][dY].m_sOwnerType == 66)
        return false;
    if ((dY > 0) && (m_pData[dX][dY - 1].m_sOwnerType == 66))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY + 1].m_sOwnerType == 66))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY].m_sOwnerType == 66))
        return false;
    if ((dX > 0) && (dY > 0) && (m_pData[dX - 1][dY - 1].m_sOwnerType == 66))
        return false;

    if (m_pData[dX + 1][dY + 1].m_sOwnerType == 73)
        return false;
    if (m_pData[dX + 1][dY].m_sOwnerType == 73)
        return false;
    if ((dY > 0) && (m_pData[dX + 1][dY - 1].m_sOwnerType == 73))
        return false;
    if (m_pData[dX][dY + 1].m_sOwnerType == 73)
        return false;
    if (m_pData[dX][dY].m_sOwnerType == 73)
        return false;
    if ((dY > 0) && (m_pData[dX][dY - 1].m_sOwnerType == 73))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY + 1].m_sOwnerType == 73))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY].m_sOwnerType == 73))
        return false;
    if ((dX > 0) && (dY > 0) && (m_pData[dX - 1][dY - 1].m_sOwnerType == 73))
        return false;

    if (m_pData[dX + 1][dY + 1].m_sOwnerType == 81)
        return false;
    if (m_pData[dX + 1][dY].m_sOwnerType == 81)
        return false;
    if ((dY > 0) && (m_pData[dX + 1][dY - 1].m_sOwnerType == 81))
        return false;
    if (m_pData[dX][dY + 1].m_sOwnerType == 81)
        return false;
    if (m_pData[dX][dY].m_sOwnerType == 81)
        return false;
    if ((dY > 0) && (m_pData[dX][dY - 1].m_sOwnerType == 81))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY + 1].m_sOwnerType == 81))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY].m_sOwnerType == 81))
        return false;
    if ((dX > 0) && (dY > 0) && (m_pData[dX - 1][dY - 1].m_sOwnerType == 81))
        return false;

    if (m_pData[dX + 1][dY + 1].m_sOwnerType == 91)
        return false;
    if (m_pData[dX + 1][dY].m_sOwnerType == 91)
        return false;
    if ((dY > 0) && (m_pData[dX + 1][dY - 1].m_sOwnerType == 91))
        return false;
    if (m_pData[dX][dY + 1].m_sOwnerType == 91)
        return false;
    if (m_pData[dX][dY].m_sOwnerType == 91)
        return false;
    if ((dY > 0) && (m_pData[dX][dY - 1].m_sOwnerType == 91))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY + 1].m_sOwnerType == 91))
        return false;
    if ((dX > 0) && (m_pData[dX - 1][dY].m_sOwnerType == 91))
        return false;
    if ((dX > 0) && (dY > 0) && (m_pData[dX - 1][dY - 1].m_sOwnerType == 91))
        return false;
    return true;
}
...
bool CMapData::bIsTeleportLoc(short sX, short sY)
{
    ...
    if (m_tile[sX][sY].m_bIsTeleport == false)
        return false;
...
#endif
{
    ...
    if (0 && (wObjectID < 30000) //TODO: fix
        && ((sX < m_sPivotX) || (sX >= m_sPivotX + MAPDATASIZEX) || (sY < m_sPivotY) || (sY >= m_sPivotY + MAPDATASIZEY)))
    {
        ...
        for (iX = sX - iAdd; iX <= sX + iAdd; iX++)
            for (iY = sY - iAdd; iY <= sY + iAdd; iY++)
            {
                ...
                if (m_pData[iX /* - m_sPivotX*/][iY /* - m_sPivotY*/].m_wObjectID == wObjectID)
                {
                    ...
                    m_pData[iX /* - m_sPivotX*/][iY /* - m_sPivotY*/].m_cOwnerName = "";
                    m_iObjectIDcacheLocX[wObjectID] = sX;
                    m_iObjectIDcacheLocY[wObjectID] = sY;
                    goto EXIT_SEARCH_LOOP;
                }
                ...
                if (m_pData[iX /* - m_sPivotX*/][iY - m_sPivotY].m_wDeadObjectID == wObjectID)
                {
                    ...
                    m_pData[iX /* - m_sPivotX*/][iY /* - m_sPivotY*/].m_cDeadOwnerName = "";
                    m_iObjectIDcacheLocX[wObjectID] = -1 * sX;
                    m_iObjectIDcacheLocY[wObjectID] = -1 * sY;
                    goto EXIT_SEARCH_LOOP;
                }
    ...
    else
    {
        ...
        if (m_iObjectIDcacheLocX[wObjectID] > 0)
        {
            ...
            if (m_pData[iX][iY].m_wObjectID == wObjectID)
            {
                ...
                if ((wObjectID != (uint16_t)m_pGame->m_sPlayerObjectID) && (m_pData[dX][dY].m_sOwnerType != 0) && (m_pData[dX][dY].m_wObjectID != wObjectID))
                {
        ...
        else if (m_iObjectIDcacheLocX[wObjectID] < 0)
        {
            ...
            if ((m_pData[iX][iY].m_cDeadOwnerFrame == -1) && (m_pData[iX][iY].m_wDeadObjectID == wObjectID))
            {
                ...
                m_pData[iX][iY].m_iDeadChatMsg = 0;
                m_pData[iX][iY].m_sDeadOwnerType = 0;
                m_pData[iX][iY].m_cDeadOwnerName = "";
    ...
    if (m_pData[dX][dY].m_sOwnerType != 0)
    {
        if ((wObjectID != (uint16_t)m_pGame->m_sPlayerObjectID) && (m_pData[dX][dY].m_wObjectID == (uint16_t)m_pGame->m_sPlayerObjectID))
            return false;
        else
            return false;
    }
    ...
    if (iPreLoc == 0)
    {
        ...
        if ((sAppr4 & 0x00F0) != 0)
        {
            ...
            {
                case 1:
                    m_pData[dX][dY].m_iEffectTotalFrame = 13;
                    break;
                case 2:
                    m_pData[dX][dY].m_iEffectTotalFrame = 11;
                    break;
            }
        }
        else
    ...
    else // iPreLoc == 1
    {
        ...
        m_pData[dX][dY].m_cDeadOwnerName = "";
...
bool __fastcall CMapData::bGetDeadOwner(short sX, short sY, short * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, int * pApprColor, short * pHeadApprValue, short * pBodyApprValue, short * pArmApprValue, short * pLegApprValue, char * pFrame, std::string & pName, short * pItemSprite, short * pItemSpriteFrame, int * pChatIndex)
{
    int dX, dY;
    ...
    *pChatIndex = m_pData[dX][dY].m_iDeadChatMsg;
    ...
    pName = m_pData[dX][dY].m_cDeadOwnerName;
...
int CMapData::iObjectFrameCounter(std::string & cPlayerName, short sViewPointX, short sViewPointY)
{
    int dX, dY, sVal;
    ...
    for (dX = sViewPointX / 32; dX <= (sViewPointX / 32) + (m_pGame->GetWidth() / 32); dX++)             //19 +/- 11
        ...
        //for (dY = 0; dY < MAPDATASIZEY; dY++)
        {
                ...
                if (m_pData[dX][dY].m_sDynamicObjectType != 0)
                {
                    ...
                    switch (m_pData[dX][dY].m_sDynamicObjectType)
                    {
                        ...
                        case DYNAMICOBJECT_FISH:
                            if ((dwTime - m_pData[dX][dY].m_dwDynamicObjectTime) < 100)
                                break;
                            m_pData[dX][dY].m_dwDynamicObjectTime = dwTime;
                            if (m_pData[dX][dY].m_cDynamicObjectFrame >= 15)
                                m_pData[dX][dY].m_cDynamicObjectFrame = 0;
                            if ((rand() % 15) == 1)
                                m_pGame->bAddNewEffect(13, (/*m_sPivotX +*/ dX) * 32 + m_pData[dX][dY].m_cDynamicObjectData1, (/*m_sPivotY +*/ dY) * 32 + m_pData[dX][dY].m_cDynamicObjectData2, 0, 0, 0);
                            ...
                            if (m_pData[dX][dY].m_cDynamicObjectData3 < -12)
                                m_pData[dX][dY].m_cDynamicObjectData3 = -12;
                            if (m_pData[dX][dY].m_cDynamicObjectData3 > 12)
                                m_pData[dX][dY].m_cDynamicObjectData3 = 12;
                            if (m_pData[dX][dY].m_cDynamicObjectData4 < -12)
                                m_pData[dX][dY].m_cDynamicObjectData4 = -12;
                            if (m_pData[dX][dY].m_cDynamicObjectData4 > 12)
                                m_pData[dX][dY].m_cDynamicObjectData4 = 12;
            ...
            if (m_pData[dX][dY].m_sOwnerType != 0)
            {
                bool isClientPlayer = (m_pData[dX][dY].m_cOwnerName == cPlayerName) ? true : false; //(dX == sCenterX && dY == sCenterY);
                sDist = (abs(sCenterX - dX) + abs(sCenterY - dY)) / 2;
                lPan = -(sCenterX - dX) * 1000;
                ...
                if ((dwTime - m_pData[dX][dY].m_dwOwnerTime) > dwFrameTime)
                {
                    ...
                    if (m_pData[dX][dY].m_cOwnerFrame > m_stFrame[m_pData[dX][dY].m_sOwnerType][m_pData[dX][dY].m_cOwnerAction].m_sMaxFrame)
                    {
                        ...
                        //BESK RESOLUTION
                        if ((m_sRectX <= dX) && ((m_sRectX + 24) >= dX) && (m_sRectY <= dY) && ((m_sRectY + 18) >= dY))
                        {
                            //end resolution
                    ...
                    else if (m_pData[dX][dY].m_cOwnerAction == OBJECTMOVE)
                    { //2 //004977BF
                        switch (m_pData[dX][dY].m_sOwnerType)
                        {
                            case 1:
                            ...
                            case 54: // Dark-Elf
                                if ((m_pData[dX][dY].m_cOwnerFrame == 1) || (m_pData[dX][dY].m_cOwnerFrame == 5))
                                {
                                    ...
                                    if ((((m_pData[dX][dY].m_iStatus & 0x00000F00) >> 8) > rand() % 6) // Angel stars
                                        && ((m_pData[dX][dY].m_iStatus & 0x0000F000) != 0) && ((m_pData[dX][dY].m_iStatus & 0x10) == 0))
                                    {
                            ...
                            case 44: // GHK
                                if ((m_pData[dX][dY].m_cOwnerFrame == 1) || (m_pData[dX][dY].m_cOwnerFrame == 5))
                                {
                                    ...
                                    if (m_pGame->m_weather >= WEATHER_LIGHTRAIN && m_pGame->m_weather <= WEATHER_HEAVYRAIN)
                                        ...
                                        m_pGame->bAddNewEffect(14, (m_sPivotX + dX) * 32 + dx, (m_sPivotY + dY) * 32 + dy, 0, 0, 0, 0);
                                    if (((m_pData[dX][dY].m_sAppr4 & 0x000F) != 0) && ((m_pData[dX][dY].m_iStatus & 0x10) == 0))
                                    {
                                        m_pGame->bAddNewEffect(54, (m_sPivotX + dX) * 32 + dx + (rand() % 20 - 10), (m_sPivotY + dY) * 32 + dy - (rand() % 50) - 5, 0, 0, -(rand() % 8), 0);
                                        m_pGame->bAddNewEffect(54, (m_sPivotX + dX) * 32 + dx + (rand() % 20 - 10), (m_sPivotY + dY) * 32 + dy - (rand() % 50) - 5, 0, 0, -(rand() % 8), 0);
                    ...
                    else if ((m_pData[dX][dY].m_cOwnerAction == OBJECTATTACK))
                    {
                        switch (m_pData[dX][dY].m_sOwnerType)
                        {
                            ...
                            case 87: // void CGame::DrawDruncncity();Crossbow Turret (Heldenian)
                                if (m_pData[dX][dY].m_cOwnerFrame == 2)
                                {
                                    m_pGame->bAddNewEffect(250, m_sPivotX + m_pData[dX][dY].m_sV1, m_sPivotY + m_pData[dX][dY].m_sV2, m_sPivotX + m_pData[dX][dY].m_sV1 + dX, m_sPivotY + m_pData[dX][dY].m_sV2 + dY, 0, 87);
                            ...
                            case 89: // void CGame::DrawDruncncity();AGT (Heldenian)
                                if (m_pData[dX][dY].m_cOwnerFrame == 2)
                                {
                                    m_pGame->bAddNewEffect(2, m_sPivotX + m_pData[dX][dY].m_sV1, m_sPivotY + m_pData[dX][dY].m_sV2, m_sPivotX + m_pData[dX][dY].m_sV1 + dX, m_sPivotY + m_pData[dX][dY].m_sV2 + dY, 0, 89);
                                    //m_pGame->PlaySound('E', 43, sDist, lPan); // Son "wouufffff"
                                }
                                break;
                            case 1:
                                ...
                                if (m_pData[dX][dY].m_cOwnerFrame == 5)
                                {
                                    ...
                                    { // not Peace mode
                                        ...
                                        { // autre que corp � corp
                                            ...
                                            if (m_pData[dX][dY].m_sV3 >= 20)
                                                m_pGame->PlaySound('E', 43, sDist, lPan); // Son "loup�"
                                        }
                                        if (((m_pData[dX][dY].m_sAppr2 & 0x0FF0) >> 4) == 15)
                                        { // StormBlade
                                            m_pGame->bAddNewEffect(81, m_sPivotX + dX, m_sPivotY + dY, m_sPivotX + dX + m_pData[dX][dY].m_sV1, m_sPivotY + dY + m_pData[dX][dY].m_sV2, 0, m_pData[dX][dY].m_sOwnerType);
                                        }
                                        else
                                        {
                                            m_pGame->bAddNewEffect(250, m_sPivotX + dX, m_sPivotY + dY, m_sPivotX + dX + m_pData[dX][dY].m_sV1, m_sPivotY + dY + m_pData[dX][dY].m_sV2, 0, m_pData[dX][dY].m_sOwnerType);
                                        }
                                    }
                            ...
                            default:
                                if (m_pData[dX][dY].m_cOwnerFrame == 2)
                                {
                                    if (m_pData[dX][dY].m_sV3 == 2)
                                    { // Arrow flying...
                                        m_pGame->bAddNewEffect(2, m_sPivotX + dX, m_sPivotY + dY, m_sPivotX + dX + m_pData[dX][dY].m_sV1, m_sPivotY + dY + m_pData[dX][dY].m_sV2, 0, m_pData[dX][dY].m_sOwnerType * 1000);
                                    }
                                }
                                break;
                        }
                        ...
                        switch (m_pData[dX][dY].m_sOwnerType)
                        {
                            ...
                            default:
                                if (m_pData[dX][dY].m_cOwnerFrame == 4)
                                {
                                    ...
                                    m_pGame->PlaySound('C', iSoundIndex, sDist, lPan);
                                    if (iSoundIndex == 7)
                                    { // Change the effect for Arrows hitting (no more at fixed heigh with arrow flying but on damage)
                                ...
                                switch (m_pData[dX][dY].m_sOwnerType)
                                {
                                    ...
                                    case 78: // Snoopy: Minaus
                                        if ((m_pData[dX][dY].m_cOwnerFrame == 1))
                                            m_pGame->PlaySound('M', 102, sDist, lPan);
                                        break;
    ...
    if (dynObjsNeedUpdate)
        m_dwDOframeTime = dwTime; //v1.4
    return iRet;
}
...
bool __fastcall CMapData::bSetDeadOwner(uint16_t wObjectID, short sX, short sY, short sType, char cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, short sHeadApprValue, short sBodyApprValue, short sArmApprValue, short sLegApprValue, int iStatus, std::string & pName)
{
    int dX, dY;
    std::string pTmpName;
    ...
    for (dX = sX - 2; dX <= sX + 2; dX++)
    {
        for (dY = sY - 2; dY <= sY + 2; dY++)
        {
            if (dX < m_sPivotX)
                break;
            else if (dX > m_sPivotX + MAPDATASIZEX)
                break;
            if (dY < m_sPivotY)
                break;
            else if (dY > m_sPivotY + MAPDATASIZEY)
                break;

            if (m_pData[dX - m_sPivotX][dY - m_sPivotY].m_cDeadOwnerName == pTmpName)
            {
                m_pData[dX - m_sPivotX][dY - m_sPivotY].m_sDeadOwnerType = 0;
                m_pData[dX - m_sPivotX][dY - m_sPivotY].m_cDeadOwnerName = "";
                bEraseFlag = true;
            }
        }
    }
...
bool __fastcall CMapData::bGetOwner(short sX, short sY, std::string & pName, short * pOwnerType, int * pOwnerStatus, uint16_t * pObjectID, short * dynObjectType)
{
    int dX, dY;
    ...
    switch (sType)
    {
        ...
        case DYNAMICOBJECT_PCLOUD_BEGIN:
            if (bIsEvent == false)
            {
                ...
                m_pData[dX][dY].m_cDynamicObjectFrame = -1 * (rand() % 8);
            break;
...
void CMapData::GetOwnerStatusByObjectID(uint16_t wObjectID, char * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, short * pHeadApprValue, short * pBodyApprValue, short * pArmApprValue, short * pLegApprValue, int * pStatus, int * pColor, std::string & pName) // Re-Coding Sprite xRisenx
{
    int iX, iY;
    for (iX = 0; iX < MAPDATASIZEX; iX++)
        for (iY = 0; iY < MAPDATASIZEY; iY++)
