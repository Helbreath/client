...
void CTile::Clear()
{
	...
	m_sHeadApprValue = NULL; // Re-Coding Sprite xRisenx
	m_sBodyApprValue = NULL; // Re-Coding Sprite xRisenx
	m_sArmApprValue = NULL; // Re-Coding Sprite xRisenx
	m_sLegApprValue = NULL; // Re-Coding Sprite xRisenx
