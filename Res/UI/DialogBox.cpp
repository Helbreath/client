...
void CDialogBox::SetMode(char mode)
{
	...
	case 13: //////CityHall
		...
		case 0:
			...
			AddButton(35, 220, 170, 195, 5);// Legion point services
	...
	case 20: //////NpcActionQuery
		...
		case 7: // Jehovah - New Blacksmith Function
			if (LANGUAGE == SPANISH)
			{
				AddButton(60, 160, 16, 30, 1); // Buy Weapons
				AddButton(60, 160, 28, 45, 2); // Buy (M) Armor
				AddButton(60, 160, 41, 55, 3); // Buy (W) Armor
				AddButton(60, 160, 54, 65, 4); // Sell items
				AddButton(60, 160, 67, 75, 5); // Repair All
			}else{
	...
	case 30: //////IconPanel//with 19-hight 22
		AddButton(580, 597, 5, 26, 1); // Magic
		AddButton(580, 597, 29, 50, 2); // Chat
		AddButton(600, 618, 5, 26, 3); // Character
		AddButton(600, 618, 29, 50, 4); // Inventory
		AddButton(621, 639, 5, 26, 5); // Skill
		AddButton(621, 639, 29, 50, 6); // System Menu

		AddButton(480, 510, 9, 47, 7); // Crusade
		AddButton(515, 555, 9, 47, 8); // Combat Mode Toggle

		AddButton(144, 245, 9, 47, 9); // Exp
		AddButton(263, 303, 9, 47, 10); // QuickBar
		AddButton(306, 346, 9, 47, 11); // QuickBar
		AddButton(348, 388, 9, 47, 12); // QuickBar
		AddButton(390, 430, 9, 47, 13); // QuickBar
		AddButton(433, 473, 9, 47, 14); // QuickBar
		break;
	...
	case 43: //////FriendList
		AddButton(25, 233, 45+16, 45+14*16, 1);
		AddButton(25, 25+25, 55+14*16, 55+15*16, 2);
		AddButton(80, 80+30, 55+14*16, 55+15*16, 3);
		AddButton(140, 140+45, 55+14*16, 55+15*16, 4);
		AddButton(160, 160+45, 70+14*16, 70+15*16, 5);
		break;
	...
	case DIALOG_GUILD: //////Guild
		switch (mode)
		{
		case 0:
			AddButtonList(-13 + 61, -13 + 226, 30 + 45, 30 + 45+15, 8, 1);
			break;
		...
		case 11:
			AddButton(115, 140, 300, 315, 1); // back
			AddScrollBar(230, 255, 25, 325, 2); // scrollbar
			AddButtonList(20, 240, 85, 100, 14, 3); // Questlist
			break;
