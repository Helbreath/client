...
#define	UPDATE_SCREEN_ON_VERSION_NO_MATCH2	"Ejecuta el programa \"Launcher.exe\" y vuelve a intentarlo."
...
#define	DRAW_DIALOGBOX_CITYHALL_MENU11	"Donation puntos servicios."
...
#define DRAW_DIALOGBOX_SYSMENU_WHISPER       "Mensajes"
#define DRAW_DIALOGBOX_SYSMENU_WHISPER_1      "Privados"
...
#define MSG_NOTIFY_DONATIONPT1 "No tienes suficientes Donation Points!."
#define MSG_NOTIFY_DONATIONPT2 " Dirigete a http://www.helbreathlegion.net/donate.php"
#define MSG_NOTIFY_DONATIONPT3 " Para informarte como obtener los puntos."
...
#define AUTOUPDATER "Ejecuta el programa \"Launcher.exe\" para jugar!"
...
#define	BCHECK_LOCAL_CHAT_COMMAND22	"El contador de mision ha sido encendido."
#define	BCHECK_LOCAL_CHAT_COMMAND23	"El contador de mision ha sido apagado."

#define DRAW_DIALOGBOX_YESNO1			  "¿Estas seguro que quieres eliminar este email?"
#define DRAW_DIALOGBOX_YESNO2			  "¿Estas seguro que quieres eliminar este post?"

#define	DRAW_DIALOGBOX_MAILBOX		"Buzon de correo"
#define	DRAW_DIALOGBOX_MAILBOX1		"Enviar mail (%u gold)"
#define	DRAW_DIALOGBOX_MAILBOX2		"Titulo"
#define	DRAW_DIALOGBOX_MAILBOX3		"Remitente"
#define	DRAW_DIALOGBOX_MAILBOX4		"Fecha (d/m)"
#define	DRAW_DIALOGBOX_MAILBOX5		"Destinatario: ____________"
#define	DRAW_DIALOGBOX_MAILBOX6		"Titulo: _____________________________"
#define	DRAW_DIALOGBOX_MAILBOX7		"Mensaje (%u/%u):"
#define	DRAW_DIALOGBOX_MAILBOX8		"Elementos Adjuntos (%u)"
#define	DRAW_DIALOGBOX_MAILBOX9		"Enviar"
#define	DRAW_DIALOGBOX_MAILBOX10	"Enviando..."
#define	DRAW_DIALOGBOX_MAILBOX11	"Cancelar"
#define	DRAW_DIALOGBOX_MAILBOX12	"De: %s"
#define	DRAW_DIALOGBOX_MAILBOX13	"Mensaje:"
#define	DRAW_DIALOGBOX_MAILBOX14	"Elementos Adjuntos (%u)"
#define	DRAW_DIALOGBOX_MAILBOX15	"Eliminar"
#define	DRAW_DIALOGBOX_MAILBOX16	"Atras"
#define	DRAW_DIALOGBOX_MAILBOX17	"Titulo: %s"
#define	DRAW_DIALOGBOX_MAILBOX18	"%u mails"
#define	DRAW_DIALOGBOX_MAILBOX19	"Postear mensaje (%u gold)"
#define	DRAW_DIALOGBOX_MAILBOX20	"%u mensajes"
#define	DRAW_DIALOGBOX_MAILBOX21	"Cartel"
#define	DRAW_DIALOGBOX_MAILBOX22	"Postear"
#define	DRAW_DIALOGBOX_MAILBOX23	"Posteando..."
#define	DRAW_DIALOGBOX_MAILBOX24	"Arroja un item de tu bolsa para esto"
#define	DRAW_DIALOGBOX_MAILBOX25	"Ventana para adjuntar un item."
#define	DRAW_DIALOGBOX_MAILBOX26	"Clickea un item para desadjuntar."
#define	DRAW_DIALOGBOX_MAILBOX27	"Items adjuntos: %d/%d"
#define	DRAW_DIALOGBOX_MAILBOX28	"Adjuntar"
#define	DRAW_DIALOGBOX_MAILBOX29	"Valor: %u gold"
#define	DRAW_DIALOGBOX_MAILBOX30	"Clickea un item para recuperarlo."
#define	DRAW_DIALOGBOX_MAILBOX31	"Recuperando item... Espera por favor."

#define	DRAW_DIALOGBOX_QUESTLIST_MENU1	"Ya estas actualmente en una mision."
#define	DRAW_DIALOGBOX_QUESTLIST_MENU2	"Tu debes terminar o cancelar la mision actual."
#define	DRAW_DIALOGBOX_QUESTLIST_MENU3	"felicitaciones! Haz completado tu mision!"
#define	DRAW_DIALOGBOX_QUESTLIST_MENU4	"Habla con el funcionario del ayuntamiento para completar!"
#define	DRAW_DIALOGBOX_QUESTLIST_MENU5	"No eres lider de gremio o maestro de caza!"
#define	DRAW_DIALOGBOX_QUESTLIST_MENU6	"No se puede obtener mision!"

#define	NOTIFY_MSG_HANDLER77	"No puedes teletransportarte dentro de los 15 segundos de haber recibido daño."
#define	NOTIFY_MSG_HANDLER78	"No puedes usar la teletransportacion del gremio dentro de los 15 segundos de haber recibido daño."
#define	NOTIFY_MSG_HANDLER79	"No puedes establecer el punto de construccion dentro de los 15 segundos de haber recibido daño."
#define	NOTIFY_MSG_HANDLER80	"Tu email ha sido enviado!"
#define	NOTIFY_MSG_HANDLER81	"El jugador %s no existe!"
#define	NOTIFY_MSG_HANDLER82	"Haz recibido un nuevo email de %s!"
#define	NOTIFY_MSG_HANDLER83	"No tienes suficiente oro para enviar un mail!"
#define	NOTIFY_MSG_HANDLER84	"No tienes suficiente oro para postear!"
#define	NOTIFY_MSG_HANDLER85	"%s posteo un mensage en la tabla de mensajes del gremio!"
#define	NOTIFY_MSG_HANDLER86	"Tu mensaje ha sido posteado!"
#define	NOTIFY_MSG_HANDLER87	"No tienes suficiente oro para enviar este email!"
#define	NOTIFY_MSG_HANDLER88	"Ya estas enviando este email actualmente! Espera por favor."
#define	NOTIFY_MSG_HANDLER89	"Felicidades! Tu gremio ha completado la mision!"

#define DRAW_DIALOGBOX_GUILD44	"%ss: %u"
#define DRAW_DIALOGBOX_GUILD45	"Tabla de mensajes"
#define DRAW_DIALOGBOX_GUILD46	"Listado de misiones"
#define DRAW_DIALOGBOX_GUILD47	"Cancelar mision"
#define DRAW_DIALOGBOX_GUILD48	"Encontrar"
#define DRAW_DIALOGBOX_GUILD49	"Localizacion"
#define DRAW_DIALOGBOX_GUILD50	"Contri/Oro/Mjs"

#define MSG_NOTIFY_DONATIONPT4 "No tienes suficientes fichas."
#define MSG_NOTIFY_DONATIONPT5 "No tienes ese hechizo."

#define	SKILL_LOGOUT	"El deslogueo fue cancelado por usar una habilidad!"

#define	DLGBOX_CLICK_NPCACTION_QUERY10 "Solo puedes enviar un maximo de 10 items."

#define	DRAW_DIALOGBOX_CITYHALL_MENU9	"Listado de misiones."

#define	DRAW_DIALOGBOX_GUILDMENU23_1	"Debes ser nivel superior a nivel 20."
#define	DRAW_DIALOGBOX_GUILDMENU23_2	"Tu carisma es menor a 20."
#define	DRAW_DIALOGBOX_GUILDMENU23_3	"Eres un criminal."
#define	DRAW_DIALOGBOX_GUILDMENU23_4	"Eres Neutral."

#define DRAW_CITYHALL4 "Buzon de correo" 

#define	DRAW_DIALOGBOX_QUEST35_1	"La mision del gremio ha sido cancelada."

#define	DRAW_DIALOGBOX_QUEST4	"Tu gremio lo ha logrado"
#define	DRAW_DIALOGBOX_QUEST4_1	"Mision de la conquista del monstruo."

#define	NOTIFYMSG_QUEST_REWARD6	"MJ: %d"
#define	NOTIFYMSG_QUEST_REWARD7	"Oro: %d"

#define GUILDQUESTHELPER	"Mision de gremio:"
#endif