...
// Snoopy: Added all 351 creature
	...
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTSTOP].m_sFrameTime		= 250;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTSTOP].m_sMaxFrame		= 7;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTMOVE].m_sFrameTime		= 100;//210;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTATTACK].m_sFrameTime	= 150;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTATTACK].m_sMaxFrame		= 3;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTDAMAGE].m_sFrameTime	= 180;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTDAMAGE].m_sMaxFrame		= 3;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTDYING].m_sFrameTime		= 180;
	m_stFrame[NPC_TYPE_PRINCESS][OBJECTDYING].m_sMaxFrame		= 7;
