...
void CDialogBox::SetMode(char mode)
{
	...
	case 10: //////Chat
		...
		AddButton(20, 50, 27, 37, 2); //   Global
		AddButton(60, 85, 27, 37, 3); //   Town
		AddButton(95, 125, 27, 37, 4); //  Nearby
		AddButton(135, 165, 27, 37, 5); // Guild
		AddButton(175, 205, 27, 37, 6); // Party
		AddButton(215, 250, 27, 37, 7); // Whisper
		AddButton(260, 275, 27, 37, 8); // GM
		AddButton(285, 310, 27, 37, 9); // All 
		break;
	...
	case 30: //////IconPanel
		AddButton(322, 355, 7, 48, 1); // Crusade
		AddButton(362, 404, 7, 48, 2); // Combat Mode Toggle
		AddButton(412, 447, 7, 48, 3); // Character
		AddButton(450, 484, 7, 48, 4); // Inventory
		AddButton(485, 521, 7, 48, 5); // Magic
		AddButton(522, 558, 7, 48, 6); // Skill
		AddButton(559, 595, 7, 48, 7); // Chat
		AddButton(596, 630, 7, 48, 8); // System Menu
		AddButton(144, 317, 7, 48, 9); // Exp
		break;
